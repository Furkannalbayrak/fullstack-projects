    ...
    return (
        ...
        <div className='pb-16'>
            <div className='flex items-center -space-x-14 w-10/12 mx-auto'>
                <input type="text" value={getId} onChange={(e) => setGetId(e.target.value)} className='w-96 lg:text-xl md:text-lg text-md bg-gray-200 pl-10 pr-20 py-3 rounded-full outline-none' placeholder="Aramak istediğiniz ID'yi giriniz" />
            ...
            {
                (data.length === 0) ? (
                    <div className='p-4 lg:text-xl md:text-lg text-md text-red-500 w-10/12 mx-auto'>Lütfen Data basede bulunan bir ID giriniz</div>
                )
                    : (
