    ...
    return (
        ...
        <div>
            <div className='flex items-center -space-x-14 ml-8'>
                <input type="text" value={getId} onChange={(e) => setGetId(e.target.value)} className='w-10/12 text-xl bg-red-100 pl-10 pr-20 py-3 rounded-full outline-none' placeholder="Aramak istediğiniz ID'yi giriniz"/>
