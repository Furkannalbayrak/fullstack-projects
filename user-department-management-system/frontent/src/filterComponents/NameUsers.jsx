    ...
    return (
        <div className='pb-16'>
            <div className='flex items-center -space-x-14 ml-8'>
                <input type="text" value={inputValue} onChange={(e) => setInputValue(e.target.value)} className='w-1/2 text-xl bg-gray-200 pl-10 pr-20 py-3 rounded-full outline-none' placeholder='Aramak istediğiniz ismi giriniz' />
            ...
            {
                (data.length === 0) ? (
                    <div className='p-4 text-xl text-red-500 ml-6'>Lütfen Data basede bulunan bir ad giriniz</div>
                )
                    : (
