            ...
            <div>
              ...
              <div className='text-center mt-5'>
                <form onSubmit={addTodo} className='flex gap-3 bg-white rounded-xl shadow-[0_5px_6px_-1px_rgba(0,0,0,0.1)] p-6'>
                  ...
                  />
                  <button type='submit' className='bg-blue-400 text-white px-7 rounded-md text-lg font-semibold transition duration-200 hover:bg-blue-600'>Ekle</button>
                </form>
              </div>
            </div>

            <div className='bg-white rounded-xl mt-8 shadow-[0_5px_6px_-1px_rgba(0,0,0,0.1)] overflow-y-auto max-h-[380px]'>
              {todos.length === 0 ?
                (
